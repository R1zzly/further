...
import (
	...
	"further/internal/jsonlog"
	"further/internal/mailer"
...
func main() {
	...
	flag.StringVar(&cfg.smtp.username, "smtp-username", "211380@astanait.edu.kz", "SMTP username")
	flag.StringVar(&cfg.smtp.password, "smtp-password", "123424Rr", "SMTP password")
	flag.StringVar(&cfg.smtp.sender, "smtp-sender", "211380@astanait.edu.kz", "SMTP sender")
...
// go run ./cmd/api -smtp-host="smtp.office365.com" -smtp-username="211380@astanait.edu.kz" -smtp-password="123424Rr" -smtp-sender="" -smtp-port=587
